...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredWasm, loadDynamicModule} = {}) {
    ...
    const dart2wasm = {
      ...
      _1596: (x0,x1,x2,x3) => globalThis.firebase_analytics.logEvent(x0,x1,x2,x3),
      _1598: (x0,x1) => globalThis.firebase_analytics.setAnalyticsCollectionEnabled(x0,x1),
      _1601: (x0,x1) => globalThis.firebase_analytics.initializeAnalytics(x0,x1),
      _1603: (x0,x1) => x0.getItem(x1),
      _1605: (x0,x1,x2) => x0.setItem(x1,x2),
      _1606: (x0,x1) => x0.querySelector(x1),
      _1607: x0 => ({type: x0}),
      _1608: (x0,x1) => new Blob(x0,x1),
      _1609: x0 => globalThis.URL.createObjectURL(x0),
      _1610: (x0,x1) => x0.item(x1),
      _1611: () => new FileReader(),
      ...
      _1615: (x0,x1,x2) => x0.removeEventListener(x1,x2),
      ...
      _1620: (x0,x1) => x0.removeChild(x1),
      _1621: x0 => x0.click(),
      _1622: x0 => new Blob(x0),
      _1623: x0 => globalThis.URL.revokeObjectURL(x0),
      _1626: (x0,x1,x2,x3,x4,x5,x6,x7) => ({apiKey: x0,authDomain: x1,databaseURL: x2,projectId: x3,storageBucket: x4,messagingSenderId: x5,measurementId: x6,appId: x7}),
      _1627: (x0,x1) => globalThis.firebase_core.initializeApp(x0,x1),
      _1628: x0 => globalThis.firebase_core.getApp(x0),
      _1629: () => globalThis.firebase_core.getApp(),
      _1630: (x0,x1,x2) => globalThis.firebase_core.registerVersion(x0,x1,x2),
      _1632: () => globalThis.firebase_core.SDK_VERSION,
      _1638: x0 => x0.apiKey,
      _1640: x0 => x0.authDomain,
      _1642: x0 => x0.databaseURL,
      _1644: x0 => x0.projectId,
      _1646: x0 => x0.storageBucket,
      _1648: x0 => x0.messagingSenderId,
      _1650: x0 => x0.measurementId,
      _1652: x0 => x0.appId,
      _1654: x0 => x0.name,
      _1655: x0 => x0.options,
      ...
      _1661: (x0,x1) => ({createScript: x0,createScriptURL: x1}),
      _1662: (x0,x1,x2) => x0.createPolicy(x1,x2),
      _1663: (x0,x1) => x0.createScriptURL(x1),
      _1664: (x0,x1,x2) => x0.createScript(x1,x2),
      ...
      _1703: (o, p, r) => o.replaceAll(p, () => r),
      _1704: (o, p, r) => o.replace(p, () => r),
      _1705: Function.prototype.call.bind(String.prototype.toLowerCase),
      _1706: s => s.toUpperCase(),
      _1707: s => s.trim(),
      _1708: s => s.trimLeft(),
      _1709: s => s.trimRight(),
      _1710: (string, times) => string.repeat(times),
      _1711: Function.prototype.call.bind(String.prototype.indexOf),
      _1712: (s, p, i) => s.lastIndexOf(p, i),
      _1713: (string, token) => string.split(token),
      _1714: Object.is,
      ...
      _1734: o => o instanceof Uint8Array,
      _1735: (o, start, length) => new Uint8Array(o.buffer, o.byteOffset + start, length),
      ...
      _1802: (x0,x1) => x0.exec(x1),
      _1803: (x0,x1) => x0.test(x1),
      _1804: x0 => x0.pop(),
      _1806: o => o === undefined,
      _1808: o => typeof o === 'function' && o[jsWrappedDartFunctionSymbol] === true,
      _1810: o => {
        const proto = Object.getPrototypeOf(o);
        return proto === Object.prototype || proto === null;
      },
      _1811: o => o instanceof RegExp,
      _1812: (l, r) => l === r,
      _1813: o => o,
      _1814: o => o,
      _1815: o => o,
      ...
      _1827: (o, p) => o[p],
      _1828: (o, p, v) => o[p] = v,
      _1829: (o, m, a) => o[m].apply(o, a),
      _1831: o => String(o),
      _1832: (p, s, f) => p.then(s, (e) => f(e, e === undefined)),
      _1833: f => finalizeWrapper(f, function(x0) { return dartInstance.exports._1833(f,arguments.length,x0) }),
      _1834: f => finalizeWrapper(f, function(x0,x1) { return dartInstance.exports._1834(f,arguments.length,x0,x1) }),
      _1835: o => {
      ...
      _1836: o => [o],
      _1837: (o0, o1) => [o0, o1],
      _1838: (o0, o1, o2) => [o0, o1, o2],
      _1839: (o0, o1, o2, o3) => [o0, o1, o2, o3],
      ...
      _1847: (jsArray, jsArrayOffset, wasmArray, wasmArrayOffset, length) => {
      ...
      _1849: (jsArray, jsArrayOffset, wasmArray, wasmArrayOffset, length) => {
        const setValue = dartInstance.exports.$wasmF64ArraySet;
        for (let i = 0; i < length; i++) {
          setValue(wasmArray, wasmArrayOffset + i, jsArray[jsArrayOffset + i]);
        }
      },
      _1850: x0 => new ArrayBuffer(x0),
      _1851: s => {
        if (/[[\]{}()*+?.\\^$|]/.test(s)) {
            s = s.replace(/[[\]{}()*+?.\\^$|]/g, '\\$&');
        }
      ...
      _1854: x0 => x0.groups,
      _1855: x0 => x0.flags,
      _1856: x0 => x0.multiline,
      _1857: x0 => x0.ignoreCase,
      _1858: x0 => x0.unicode,
      _1859: x0 => x0.dotAll,
      _1860: (x0,x1) => { x0.lastIndex = x1 },
      _1861: (o, p) => p in o,
      _1862: (o, p) => o[p],
      _1863: (o, p, v) => o[p] = v,
      _1864: (o, p) => delete o[p],
      _1872: f => finalizeWrapper(f, function(x0) { return dartInstance.exports._1872(f,arguments.length,x0) }),
      _1880: () => new AbortController(),
      _1881: x0 => x0.abort(),
      _1882: (x0,x1,x2,x3,x4,x5) => ({method: x0,headers: x1,body: x2,credentials: x3,redirect: x4,signal: x5}),
      _1883: (x0,x1) => globalThis.fetch(x0,x1),
      _1884: (x0,x1) => x0.get(x1),
      _1885: f => finalizeWrapper(f, function(x0,x1,x2) { return dartInstance.exports._1885(f,arguments.length,x0,x1,x2) }),
      _1886: (x0,x1) => x0.forEach(x1),
      _1887: x0 => x0.getReader(),
      _1888: x0 => x0.cancel(),
      _1889: x0 => x0.read(),
      _1890: x0 => x0.trustedTypes,
      _1891: (x0,x1) => { x0.text = x1 },
      _1892: x0 => x0.random(),
      _1895: () => globalThis.Math,
      ...
      _2064: (x0,x1) => { x0.draggable = x1 },
      _2080: x0 => x0.style,
      _2437: (x0,x1) => { x0.target = x1 },
      _2439: (x0,x1) => { x0.download = x1 },
      _2464: (x0,x1) => { x0.href = x1 },
      _3009: (x0,x1) => { x0.accept = x1 },
      _3023: x0 => x0.files,
      _3049: (x0,x1) => { x0.multiple = x1 },
      _3067: (x0,x1) => { x0.type = x1 },
      _3319: (x0,x1) => { x0.type = x1 },
      _3327: (x0,x1) => { x0.crossOrigin = x1 },
      _3329: (x0,x1) => { x0.text = x1 },
      _3786: () => globalThis.window,
      _3826: x0 => x0.document,
      _3848: x0 => x0.navigator,
      _4110: x0 => x0.trustedTypes,
      _4111: x0 => x0.sessionStorage,
      _4112: x0 => x0.localStorage,
      _4237: x0 => x0.userAgent,
      _4445: x0 => x0.length,
      _6390: x0 => x0.signal,
      _6445: x0 => x0.baseURI,
      _6451: x0 => x0.firstChild,
      _6462: () => globalThis.document,
      _6546: x0 => x0.head,
      _6878: (x0,x1) => { x0.id = x1 },
      _6905: x0 => x0.children,
      _8224: x0 => x0.value,
      _8226: x0 => x0.done,
      _8406: x0 => x0.size,
      _8407: x0 => x0.type,
