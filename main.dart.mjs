...
class CompiledApp {
  ...
  async instantiate(additionalImports,
    ...
    const dart2wasm = {
      ...
      _1317: (x0,x1,x2,x3) => globalThis.firebase_analytics.logEvent(x0,x1,x2,x3),
      _1319: (x0,x1) => globalThis.firebase_analytics.setAnalyticsCollectionEnabled(x0,x1),
      _1322: (x0,x1) => globalThis.firebase_analytics.initializeAnalytics(x0,x1),
      ...
      _1341: (x0,x1) => x0.removeChild(x1),
      _1342: x0 => x0.click(),
      _1343: x0 => new Blob(x0),
      _1344: x0 => globalThis.URL.revokeObjectURL(x0),
      _1347: (x0,x1,x2,x3,x4,x5,x6,x7) => ({apiKey: x0,authDomain: x1,databaseURL: x2,projectId: x3,storageBucket: x4,messagingSenderId: x5,measurementId: x6,appId: x7}),
      _1348: (x0,x1) => globalThis.firebase_core.initializeApp(x0,x1),
      _1349: x0 => globalThis.firebase_core.getApp(x0),
      _1350: () => globalThis.firebase_core.getApp(),
      _1351: (x0,x1,x2) => globalThis.firebase_core.registerVersion(x0,x1,x2),
      _1353: () => globalThis.firebase_core.SDK_VERSION,
      _1359: x0 => x0.apiKey,
      _1361: x0 => x0.authDomain,
      _1363: x0 => x0.databaseURL,
      _1365: x0 => x0.projectId,
      _1367: x0 => x0.storageBucket,
      _1369: x0 => x0.messagingSenderId,
      _1371: x0 => x0.measurementId,
      _1373: x0 => x0.appId,
      _1375: x0 => x0.name,
      _1376: x0 => x0.options,
      _1379: (x0,x1) => x0.debug(x1),
      _1380: (module,f) => finalizeWrapper(f, function(x0) { return module.exports._1380(f,arguments.length,x0) }),
      _1381: (module,f) => finalizeWrapper(f, function(x0,x1) { return module.exports._1381(f,arguments.length,x0,x1) }),
      _1382: (x0,x1) => ({createScript: x0,createScriptURL: x1}),
      _1383: (x0,x1,x2) => x0.createPolicy(x1,x2),
      _1384: (x0,x1) => x0.createScriptURL(x1),
      _1385: (x0,x1,x2) => x0.createScript(x1,x2),
      _1386: (x0,x1) => x0.appendChild(x1),
      _1387: (module,f) => finalizeWrapper(f, function(x0) { return module.exports._1387(f,arguments.length,x0) }),
      _1388: (x0,x1) => x0.key(x1),
      _1398: Date.now,
      ...
      _1545: (x0,x1) => x0.exec(x1),
      _1546: (x0,x1) => x0.test(x1),
      _1547: x0 => x0.pop(),
      _1549: o => o === undefined,
      _1551: o => typeof o === 'function' && o[jsWrappedDartFunctionSymbol] === true,
      _1553: o => {
        const proto = Object.getPrototypeOf(o);
        return proto === Object.prototype || proto === null;
      },
      _1554: o => o instanceof RegExp,
      _1555: (l, r) => l === r,
      _1556: o => o,
      _1557: o => o,
      _1558: o => o,
      ...
      _1621: (x0,x1) => new WebSocket(x0,x1),
      _1622: (x0,x1) => x0.send(x1),
      _1623: (x0,x1,x2) => x0.close(x1,x2),
      _1624: (x0,x1) => x0.close(x1),
      _1625: x0 => x0.close(),
      _1628: x0 => new BroadcastChannel(x0),
      _1629: (module,f) => finalizeWrapper(f, function(x0) { return module.exports._1629(f,arguments.length,x0) }),
      _1630: (x0,x1) => x0.postMessage(x1),
      _1631: x0 => x0.close(),
      ...
      _1640: x0 => x0.cancel(),
      _1641: x0 => x0.read(),
      _1642: x0 => x0.trustedTypes,
      _1643: (x0,x1) => { x0.text = x1 },
      _1644: o => o instanceof Array,
      _1645: (a, i) => a.push(i),
      _1648: (a, l) => a.length = l,
      _1649: a => a.pop(),
      _1650: (a, i) => a.splice(i, 1),
      _1652: (a, s, e) => a.slice(s, e),
      _1654: (a, b) => a == b ? 0 : (a > b ? 1 : -1),
      _1655: a => a.length,
      _1657: (a, i) => a[i],
      _1658: (a, i, v) => a[i] = v,
      _1660: o => {
      ...
      _1661: (o, offsetInBytes, lengthInBytes) => {
        var dst = new ArrayBuffer(lengthInBytes);
        new Uint8Array(dst).set(new Uint8Array(o, offsetInBytes, lengthInBytes));
        return new DataView(dst);
      },
      _1663: o => o instanceof Uint8Array,
      _1664: (o, start, length) => new Uint8Array(o.buffer, o.byteOffset + start, length),
      _1665: o => o instanceof Int8Array,
      _1666: (o, start, length) => new Int8Array(o.buffer, o.byteOffset + start, length),
      _1667: o => o instanceof Uint8ClampedArray,
      _1668: (o, start, length) => new Uint8ClampedArray(o.buffer, o.byteOffset + start, length),
      _1669: o => o instanceof Uint16Array,
      _1670: (o, start, length) => new Uint16Array(o.buffer, o.byteOffset + start, length),
      _1671: o => o instanceof Int16Array,
      _1672: (o, start, length) => new Int16Array(o.buffer, o.byteOffset + start, length),
      _1673: o => o instanceof Uint32Array,
      _1674: (o, start, length) => new Uint32Array(o.buffer, o.byteOffset + start, length),
      _1675: o => o instanceof Int32Array,
      _1676: (o, start, length) => new Int32Array(o.buffer, o.byteOffset + start, length),
      _1678: (o, start, length) => new BigInt64Array(o.buffer, o.byteOffset + start, length),
      _1679: o => o instanceof Float32Array,
      _1680: (o, start, length) => new Float32Array(o.buffer, o.byteOffset + start, length),
      _1681: o => o instanceof Float64Array,
      _1682: (o, start, length) => new Float64Array(o.buffer, o.byteOffset + start, length),
      _1683: (t, s) => t.set(s),
      ...
      _1728: () => globalThis.document,
      _1734: (x0,x1) => { x0.height = x1 },
      _1736: (x0,x1) => { x0.width = x1 },
      _1738: (x0,x1) => { x0.pointerEvents = x1 },
      _1747: x0 => x0.style,
      _1750: x0 => x0.src,
      _1751: (x0,x1) => { x0.src = x1 },
      _1752: x0 => x0.naturalWidth,
      _1753: x0 => x0.naturalHeight,
      _1769: x0 => x0.status,
      _1770: (x0,x1) => { x0.responseType = x1 },
      _1772: x0 => x0.response,
      _1882: (x0,x1) => { x0.draggable = x1 },
      _1898: x0 => x0.style,
      _2255: (x0,x1) => { x0.target = x1 },
      _2257: (x0,x1) => { x0.download = x1 },
      _2282: (x0,x1) => { x0.href = x1 },
      _2827: (x0,x1) => { x0.accept = x1 },
      _2841: x0 => x0.files,
      _2867: (x0,x1) => { x0.multiple = x1 },
      _2885: (x0,x1) => { x0.type = x1 },
      _3137: (x0,x1) => { x0.type = x1 },
      _3145: (x0,x1) => { x0.crossOrigin = x1 },
      _3147: (x0,x1) => { x0.text = x1 },
      _3604: () => globalThis.window,
      _3644: x0 => x0.document,
      _3647: x0 => x0.location,
      _3666: x0 => x0.navigator,
      _3928: x0 => x0.trustedTypes,
      _3929: x0 => x0.sessionStorage,
      _3930: x0 => x0.localStorage,
      _3938: x0 => x0.href,
      _4055: x0 => x0.userAgent,
      _4106: x0 => x0.data,
      _4153: (x0,x1) => { x0.onmessage = x1 },
      _4260: x0 => x0.length,
      _4477: x0 => x0.readyState,
      _4486: x0 => x0.protocol,
      _4490: (x0,x1) => { x0.binaryType = x1 },
      _4493: x0 => x0.code,
      _4494: x0 => x0.reason,
      _6202: x0 => x0.signal,
      _6257: x0 => x0.baseURI,
      ...
      _8734: x0 => x0.url,
      _8736: x0 => x0.status,
      _8738: x0 => x0.statusText,
      _8739: x0 => x0.headers,
      _8740: x0 => x0.body,
      _11146: (x0,x1) => { x0.display = x1 },
      _12368: x0 => x0.name,
      _13076: () => globalThis.console,
      _13104: x0 => x0.name,
      _13105: x0 => x0.message,
      _13106: x0 => x0.code,
